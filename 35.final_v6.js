...
` +
        `پلن: MarketiQ PRO | با ارزش: 25 USDT
  ...
  <div class="shell">
    ...
    <div class="grid">
      ...
      <div class="card" id="userWalletCard">
        ...
        <div class="card-b">
          <div class="mini-list">
            <div>پلن: <b id="planName">MarketiQ PRO</b> — با ارزش <b id="planPrice">25</b> USDT (<span id="planNetwork">BEP20</span>)</div>
          ...
          <div class="field">
            ...
            <div class="muted" style="font-size:12px; line-height:1.8;">واریزی فقط به آدرس ولت درگاه ممکن است<br>در لیست زیر باید از واریز هش واریزی را ارسال کنید.<br>اگر مبلغ رو نزنی، 25 در نظر می‌گیریم.</div>
          </div>
      ...
      <div class="card" id="userInviteCard">
        ...
        <div class="card-b">
          ...
          <div class="field" style="margin-top:10px">
            <div class="label">لینک اختصاصی دعوت</div>
            <div class="admin-row">
